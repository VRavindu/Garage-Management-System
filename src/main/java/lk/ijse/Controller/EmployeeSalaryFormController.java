...
public class EmployeeSalaryFormController {
    ...
    private void getWorkingDays(){
        ...
        try {
            String dayCount = model.getWorkingDays(id, monthNumber);
    ...
    private void generateNextSalaryId() {
        try {
            String salaryId = employeeModel.generateNextSalaryId();
    ...
    public void btnSalaryOnAction(ActionEvent actionEvent) {
        ...
        if (isValidSalary) {
            ...
            try {
                boolean isPay = model.saveSalary(dto);
                if (isPay) {
    ...
    private void loadAllSalary(){
        ...
        try {
            List<EmpSalaryDto> dtoList = model.getAllSalary();
